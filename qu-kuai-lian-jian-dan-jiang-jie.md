...
2. 中心化的资源不可能被再分割,历来财富不均匀到极端必然引起民众反叛推翻政府,从而再次分割财富,但是如果到了区块链时代呢?阶

3. 目前区块链的主要应用是虚拟货币,然后大部分的虚拟货币集中在了少部分人手里,这还是以去中心为重点的区块链的发展之路吗?

4. 去中心的区块链和高度中心的国家信用体系是相互补充还是相悖,取决于政府的态度.
